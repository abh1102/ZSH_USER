...
#include <syncfusion_pdfviewer_linux/syncfusion_pdfviewer_linux.h>
...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) syncfusion_pdfviewer_linux_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "SyncfusionPdfviewerLinux");
  syncfusion_pdfviewer_linux_register_with_registrar(syncfusion_pdfviewer_linux_registrar);
